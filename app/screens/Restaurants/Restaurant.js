  ...
  const addFavorite = () => {
    if (!userLogged) {
      ...
      db.collection("favorites")
        ...
        .then(() => {
          setIsFavorite(true);
          toastRef.current.show("Negocio añadido a la lista de favoritos");
        })
        .catch(() => {
          toastRef.current.show(
            "Error al añadir el negocio a la lista de favoritos, intentelo más tarde"
          );
        });
    }
  };
        ...
        response.forEach(doc => {
          ...
          db.collection("favorites")
            ...
            .then(() => {
              setIsFavorite(false);
              toastRef.current.show(
                "Negocio eliminado de la lista de favoritos"
              );
            })
            .catch(() => {
              toastRef.current.show(
...
function RestaurantInfo(props) {
  const { location, name, phone, email, address  } = props;
