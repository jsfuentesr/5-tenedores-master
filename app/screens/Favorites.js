...
export default function Favorites(props) {
  ...
  return (
    <View style={styles.viewBody}>
      ...
      <Loading text="Eliminando Negoico" isVisible={isVisibleLoding} />
    </View>
  );
}
...
function Restaurant(props) {
  ...
  const confirmRemoveFavorite = () => {
    Alert.alert(
      ...
      "¿Estas seguro de que quieres eliminar el negocio de favoritos?",
      [
        {
          text: "Cancel",
          style: "cancel"
          ...
          db.collection("favorites")
            ...
            .catch(() => {
              toastRef.current.show(
                "Error al eliminar el negocio, intentelo más tarde"
              );
            });
        });
      });
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      ...
      <Text style={{ fontSize: 20, fontWeight: "bold" }}>
        No tienes negocios en tu lista
      </Text>
    </View>
  );
}
